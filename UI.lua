...
do
	...
	do
		...
		function Library:Window(Options)
			...
			game:GetService("RunService").RenderStepped:Connect(function ()
				if Outline.Visible == true then
					...
					local mousepos = UDim2.new(0, game:GetService("UserInputService"):GetMouseLocation().X - 3, 0, game:GetService("UserInputService"):GetMouseLocation().Y - 52)
		...
		function Library:Page(Properties)
            ...
            Left.CanvasSize = UDim2.new(0.5, -6, 0, 0)
			Left.ZIndex = 2
            ...
            Right.CanvasSize = UDim2.new(0.5, -6, 0, 0)
